package net.mcreator.usefulzombieflesh;
...
@Mod("usefulzombieflesh")
public class UsefulzombiefleshMod {
	public static final Logger LOGGER = LogManager.getLogger(UsefulzombiefleshMod.class);
	public static final String MODID = "usefulzombieflesh";

	public UsefulzombiefleshMod() {
		...
		UsefulzombiefleshModTabs.REGISTRY.register(bus);
